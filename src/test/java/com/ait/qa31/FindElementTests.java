...
public class FindElementTests {
    ...
    public void setUp() {
        ...
        // разворачиваем браузер до максимального размера окна
        driver.manage().window().maximize();

        // ждать чтоб все элементы на странице загрузились перед тем, как начнем с ними взаимодействовать
    ...
    public void findElementByTagName() {
        ...
        // поиск списка элементов по тегу
